        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-semibold text-gray-100 mb-1">This action cannot be undone</h4>
              <p className="text-xs text-gray-400 leading-relaxed">
                You are about to permanently delete <span className="font-semibold text-red-400">{filtered.length} {filtered.length === 1 ? 'item' : 'items'}</span> from the recycle bin. Once deleted, they cannot be recovered.
              </p>
            </div>
          </div>
