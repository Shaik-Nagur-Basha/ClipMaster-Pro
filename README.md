...
- **Milestone**: Version 2.2.2 complete with custom version switcher, native updater, and crash-resilient storage engine.
...
## Documentation
- **[Release Notes](RELEASE_NOTES.md)** — Detailed v2.2.2 changelog.
